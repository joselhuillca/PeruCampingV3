...
namespace MLearning.Core.Configuration
{
    ...
    public class Constants
    {
		...
		//Seccion de Mis Marcadores -----------------
		public static Marcadores GetMarkers(string prefFilename)
		{
			return new Marcadores(prefFilename);
		}
		public static string MarkersFileName = "my_markers";

		public static string MarkerTitleKey = "marker_title";
		public static string MarkerInfoKey = "marker_info";
		public static string MarkerIdKey = "marker_id";
		//Fin Marker ---------------------------
